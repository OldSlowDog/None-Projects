# ESP32-S Smart Fan Controller (自制制冷风扇)

> **⚠️ 免责声明 / Disclaimer**
>
> 本项目的初始设计（V2.6）存在以下已知问题：
>
> | 问题 | 说明 |
> |------|------|
> | 💰 **成本高** | 材料与元器件选型成本远高于成品方案 |
> | 🔊 **噪音大** | 多风扇 + 风道设计不佳，运行噪音明显 |
> | ⚡ **不安全** | 自组电路缺乏专业保护，存在短路、过载等隐患 |
> | 🌬️ **风量小** | 风道/散热结构设计不合理，实际制冷效果有限 |
> | 🕸️ **布线乱** | 手工飞线，走线混乱，维护困难 |
> | 🔋 **耗电大** | TEC 半导体制冷片 + 多风扇同时运行功耗较高 |
> | 💧 **漏水风险** | 冷凝水处理未完善，有短路及损坏风险 |
>
> **本项目为个人 DIY 初设，安全性无法保障。** 强烈建议:
> - 自行重新设计结构模型和电路方案
> - 添加保险丝、温度保护、漏电保护等安全措施
> - 本项目内容**仅供参考，任何直接使用造成的损失由使用者自行承担**

基于 ESP32-S 的自制制冷风扇控制器，支持双风扇调速、TEC 半导体制冷片控制、温度监测、OLED 菜单及 WiFi 控制等功能。
